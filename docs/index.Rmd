...
design_table<-tibble:: tribble (~Question, ~Hypothesis, ~Sampling_Plan, ~Analysis_Plan, ~Interpretation, Question[1], Hypothesis[1:4], Sampling_Plan[1], Analysis_Plan[1], Interpretation[1],
Question[2], Hypothesis[5], Sampling_Plan[2], Analysis_Plan[2], Interpretation[2],
Question[3], Hypothesis[6], Sampling_Plan[3], Analysis_Plan[3], Interpretation[3],
Question[4], Hypothesis[7], Sampling_Plan[4], Analysis_Plan[4], Interpretation[4],
Question[5], Hypothesis[8], Sampling_Plan[5], Analysis_Plan[5], Interpretation[5],
Question[6], Hypothesis[9:10], Sampling_Plan[6], Analysis_Plan[6], Interpretation[6],
Question[7], Hypothesis[11:14], Sampling_Plan[7], Analysis_Plan[7], Interpretation[7],
Question[8], Hypothesis[15], Sampling_Plan[8], Analysis_Plan[8], Interpretation[8],
Question[9], Hypothesis[16], Sampling_Plan[9], Analysis_Plan[9], Interpretation[9],
Question[10], Hypothesis[17], Sampling_Plan[10], Analysis_Plan[10], Interpretation[10],
Question[11], Hypothesis[18], Sampling_Plan[11], Analysis_Plan[11], Interpretation[11],
Question[12], Hypothesis[19], Sampling_Plan[12], Analysis_Plan[12], Interpretation[12],
Question[13], Hypothesis[20], Sampling_Plan[13], Analysis_Plan[13], Interpretation[13],
Question[14], Hypothesis[21], Sampling_Plan[14], Analysis_Plan[14], Interpretation[14],
Question[15], Hypothesis[22], Sampling_Plan[15], Analysis_Plan[15], Interpretation[15],
Question[16], Hypothesis[23:26], Sampling_Plan[16], Analysis_Plan[16], Interpretation[16])




names(design_table) <- c('Question', 'Hypothesis', 'Sampling Plan', 'Analysis Plan', 'Interpretation')
