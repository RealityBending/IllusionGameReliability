...
Interpretation <- c("If greater illusion strength and task difficult is found to lead to a significant* increase (*Bayes Factor >1) in error rate and repsonse time, we will interpret that there is sufficient evidence to claim that the results of the previous Illusion Game study was successfully replicated",
