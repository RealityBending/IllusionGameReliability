...
table <- table |>
  rbind(
    ...
    list(
      Question = "Q2 Confirmation",
      Hypothesis = "H6.2 - Inter-individual illusion sensitivity will correlate positively with anxiety scores (meausured with the *Anxiety* subscale in PHQ-4)",
      Sampling = "N=400",
      Analysis = "See above.",
    ...
    list(
      Question = "Q2 Confirmation",
      Hypothesis = "H6.3 - Inter-individual illusion sensitivity will correlate negatively with borderline personality traits",
      Sampling = "N=400",
      Analysis = "See above.",
      Interpretation = "See above."
    ),
