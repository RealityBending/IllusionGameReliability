...
formula <- brms::bf(
  Error ~ Illusion_Effect / (logmod(Illusion_Difference) * abs(Illusion_Strength)) +
    (logmod(Illusion_Difference) * abs(Illusion_Strength) | Participant),
  family = "bernoulli",
  decomp = "QR"
)
...
formula <- brms::bf(
  RT ~ Illusion_Effect / (Illusion_Difference * abs(Illusion_Strength)) + poly(ISI, 2) +
    (Illusion_Effect / (Illusion_Difference * abs(Illusion_Strength)) | Participant),
  sigma ~ Illusion_Effect / (Illusion_Difference * abs(Illusion_Strength)) + poly(ISI, 2) +
    (Illusion_Effect | Participant),
...
formula <- brms::bf(
  Error ~ Illusion_Effect / (logmod(Illusion_Difference) * sqrtmod(abs(Illusion_Strength))) +
    (logmod(Illusion_Difference) * sqrtmod(abs(Illusion_Strength)) | Participant),
  family = "bernoulli",
  decomp = "QR"
)
...
formula <- brms::bf(
  RT ~ Illusion_Effect / (sqrtmod(Illusion_Difference) * abs(Illusion_Strength)) + poly(ISI, 2) +
    (Illusion_Effect / (sqrtmod(Illusion_Difference) * abs(Illusion_Strength)) | Participant),
...
```{r message=FALSE, warning=FALSE}
plot_ppcheck(p_mullerlyer_rt, gam_mullerlyer_rt)
```
