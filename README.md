# The Illusion Game: Reliability and Validity
...
Using a short version of the Illusion Game (made of 3 illusion types), the aim of the present study is to 1) replicate previous findings regarding the common factor of illusion sensitivity and its links with personality, 2) extend these findings to more targeted participant characteristics (such as schizotypal and autistic traits), 3) test the validity and reliability of the measure using a control task of perceptual discrimination and test-retest protocol.

## Hypotheses

We grouped our hypotheses according to 3 levels of expectation strength (*replication* of the Illusion Game original study, *confirmation* of the findings reported by past studies, and *exploration* of potential hypotheses based on theoretical models and assumptions). The null hypothesis (H0) corresponds to no significant effect.
...
Participants were randomly assigned to 2 different conditions, of which they were either presented with the Illusion Task followed by Perceptual Task, or vice versa. In both conditions, a series of self-report questionnaires were administered in between the 2 main experimental tasks.
...
Participants were invited to complete (only) the Illusion Task again, about 2 weeks following their initial participation. To avoid session 1 from being too long, the MAIA-2, MSI-BPD and PI-18 questionnaires were administered during session 2, after the Illusion Task.

### Design Plan

This study will have a within-subjects design with repeated measures. Data collection and analysis will not be performed blind to the conditions of the experiments. Prior to the start of the experiment, all participants will be required to give their consent via an informed consent form, where the study's purpose will be stated. However, participants will not be explicitly informed of the independent variables measured and the research hypotheses.

The materials and procedure of the experiment will be the same as the pilot study (see above).
